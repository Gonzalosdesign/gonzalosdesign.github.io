...
function prueba(){
	alert('El camino dos aun no esta disponible.')
}

function recipiente (recipiente){

	if(recipiente == "maceta"){
		var elem = document.getElementById('recipienteId');
	   	elem.src = 'img/maceta.png'
	    elem.className  = 'maceta';
   	}else if(recipiente == "bidon"){
	   	var elem = document.getElementById('recipienteId');
	   	elem.src = 'img/bidon.png';
	   	elem.className  = 'bidon';
	}else{
		var elem = document.getElementById('recipienteId');
	   	elem.src = 'img/cajon.png';
	   	elem.className  = 'cajon';
	}
}


function mouseDown(){
    document.getElementById("regadera").className = 'regadera';
}
