window.onload = function() {
  ...
  function randomColor() {
    return '#' + Math.random(8).toString(16).slice(2, 8);
  }
  ...
  function draw() {
    ...
    for (var i = 0; i < particles.length; i++) {
      var p = particles[i];
      ctx.beginPath();
      ctx.font = p.font.size + "vh Roboto";
...
words = [ "Tranquilidad", "Amistad", "Paz", "Confianza", "Seguridad", "Serenidad", "Serenidad", "Bondad", "Amor", ];
