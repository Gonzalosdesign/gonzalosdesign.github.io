// JavaScript Document
	...
	$(function () {
   function runIt() {
      $('#fondo1 img').animate({"opacity":"0.4"},500)
   ...
   runIt();
		...
		$("#intro a").append(function() {
			...
			if (divIndex < 1) {
				$("#intro a").attr("href", "#fondo1");}
			if (divIndex >= 1) {
				$("#intro a").attr("href", "#fondo1");}
			if (divIndex >= 2.19) {
				$("#intro a").attr("href", "#fondo2");}
			if (divIndex >= 3.39) {
				$("#intro a").attr("href", "#fondo3");}
			if (divIndex >= 4.59) {
				$("#intro a").attr("href", "#fondo4");}
			if (divIndex >= 5.79) {
		...
		$("#fondo1 img,#fondo1 p,#fondo1 hr").append(function() {
			if (divIndex >= 0.19 && divIndex <= 1.36) {
		$("#fondo1 img").css({display:'block'},1);
		$("#fondo1 p,#fondo1 hr").fadeIn('fast');}
			else {
		$("#fondo1 img").css({display:'none'},1);
		$("#fondo1 p,#fondo1 hr").fadeOut('fast');}
		});
